...
#define kKBSVersion		"1.1.0"						// Version of this plug-in. Shows up in three places: the About box, the .rc FileVersion, and the PluginVersion resource. First Adobe Exchange submission = 1.0.0 (2026-07-30), APPROVED AND PUBLISHED 2026-08-11 at https://exchange.adobe.com/apps/cc/205698/kohakufindchange. ***** 1.0.0 IS THE 2026-07-30 BUILD. ***** Raised to 1.1.0 on 2026-09-25 (the user's call), so the store's plug-in and this source stop sharing a number: everything after f0a6f48 - the prefix moved to 0x1EA600, Minimizable Find/Change, Remember Book Panel Placement, and the audits in between - is NOT in 1.0.0. *1.1.0 has NOT been submitted yet; this line says what the next submission will be called, not what the store has. (KESCM learned this the expensive way: "the version number in a history comment does not describe what was submitted" - memory kescm-cpp-panel.) Was kSDKDefPluginVersionString, the SDK template's own version, which said nothing about this plug-in.
